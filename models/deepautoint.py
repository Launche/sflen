...
from deepctr.layers.interaction import InteractingLayer, FM
from deepctr.layers.utils import concat_func, add_func, combined_dnn_input


def DeepAutoInt(linear_feature_columns, dnn_feature_columns, att_layer_num=3, att_embedding_size=8, att_head_num=2,
                att_res=True,
